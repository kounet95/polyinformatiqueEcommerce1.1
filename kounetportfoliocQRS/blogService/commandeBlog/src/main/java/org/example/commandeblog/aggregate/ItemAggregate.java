...
public class ItemAggregate {
    ...
    @CommandHandler(payloadType = CreatePostCommand.class)
    ...
    @CommandHandler(payloadType = CreateNewsCommand.class)
    ...
    @CommandHandler(payloadType = CreateEventCommand.class)
    ...
    @EventSourcingHandler(payloadType = PostCreatedEvent.class)
    ...
    @EventSourcingHandler(payloadType = NewsCreatedEvent.class)
    ...
    @EventSourcingHandler(payloadType = EventCreatedEvent.class)
    ...
    @CommandHandler(payloadType = UpdatePostCommand.class)
    ...
    @EventSourcingHandler(payloadType = PostUpdatedEvent.class)
    ...
    @CommandHandler(payloadType = UpdateNewsCommand.class)
    ...
    @EventSourcingHandler(payloadType = NewsUpdatedEvent.class)
    ...
    @CommandHandler(payloadType = UpdateEventCommand.class)
    ...
    @EventSourcingHandler(payloadType = EventUpdatedEvent.class)
    ...
    @CommandHandler(payloadType = DeleteItemCommand.class)
    ...
    @EventSourcingHandler(payloadType = ItemDeletedEvent.class)
